...
import 'quiz_brain3.dart';
import 'results.dart';
import 'results_3.dart';

QuizBrain3 quizBrain = QuizBrain3();
...
//                      ),
                    Row(
                      ...
                      children: <Widget>[
                        Expanded(
                            flex: 50,
                            child: Container(child: Center(child: Text("Level -3",style: TextStyle(color: Color(0xFF1687A7),fontWeight: FontWeight.bold),)))),
                        IconButton(
