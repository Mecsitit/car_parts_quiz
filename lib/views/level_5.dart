...
import 'quiz_brain5.dart';
import 'results_5.dart';


QuizBrain5 quizBrain = QuizBrain5();
...
//                      ).show();
  ...
  check() async {
    ...
    if (_correct >= _highScore) {
      ...
      prefs.setInt('highScore', _correct+80);
    }
  }
...
//                      ),
                    Row(
                      ...
                      children: <Widget>[
                        Expanded(
                            flex: 50,
                            child: Container(child: Center(child: Text("Level -5",style: TextStyle(color: Color(0xFF1687A7),fontWeight: FontWeight.bold),)))),
                        IconButton(
