...
import 'quiz_brain4.dart';
import 'results_4.dart';



QuizBrain4 quizBrain = QuizBrain4();
...
//                      ).show();
  ...
  check() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    if (_correct >= _highScore-55) {
      setState(() {
        _highScore = _correct;
      });
      prefs.setInt('highScore', _correct+60);
    }
  }
...
//                      ),
                    Row(
                      ...
                      children: <Widget>[
                        Expanded(
                            flex: 50,
                            child: Container(child: Center(child: Text("Level -4",style: TextStyle(color: Color(0xFF1687A7),fontWeight: FontWeight.bold),)))),
                        IconButton(
